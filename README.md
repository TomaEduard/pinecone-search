...
```sh
 npm start -- query --query="Food" --topK=5
```
...
```js
[
  { text: 'What is food?', score: 0.763730049 },
  { text: 'What is the for food?', score: 0.714910865 },
  { text: 'What is food would?', score: 0.638568 },
  { text: 'Is there a we eat food?', score: 0.629753828 },
  { text: 'What are eat?', score: 0.619761586 }
]
```
